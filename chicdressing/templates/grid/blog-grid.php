...
<div class="main-container" id="main-container">
	...
	// Blog Grid
	echo '<ul class="blog-grid" id="blog-grid">';
	...
	if ( have_posts() ) :
		...
		while ( have_posts() ) :
			...
			<article id="post-<?php the_ID(); ?>" <?php post_class($post_class); ?>>
				...
				<header class="post-header" id="post-header-<?php the_ID(); ?>">
					...
					<h2 class="post-title" id="post-title-<?php the_ID(); ?>">
					...
					<div class="post-meta clear-fix">
						...
						<?php if ( ashe_options( 'blog_page_show_date' ) === true ) : ?>
							<span class="post-date" id="post-date-<?php the_ID(); ?>"><?php the_time( get_option( 'date_format' ) ); ?></span>
						<?php endif; ?>
				...
				<div class="read-more" id="read-more-<?php the_ID(); ?>">
					<a href="<?php echo esc_url( get_permalink() ); ?>"><?php esc_html_e( 'read more','ashe' ); ?></a>
				</div>

				<footer class="post-footer" id="post-footer-<?php the_ID(); ?>">

					<?php if ( ashe_options( 'blog_page_show_author' ) === true ) : ?>
					<span class="post-author" id="post-author-<?php the_ID(); ?>">
